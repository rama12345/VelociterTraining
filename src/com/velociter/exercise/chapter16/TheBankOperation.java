	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		 int[] initialBalance = { 500 ,800 }; // The initial account balances.
		        ...
		        int[] numberOfCredits = new int[initialBalance.length]; // Number of credits.
		        int[] numberOfDebits = new int[initialBalance.length]; // Number of debits.
		        ...
		        for (int i = 1; i <= transactionCount; i++) {
		            ...
		            if (rand.nextInt(2) == 1) {
		                ...
		                select = rand.nextInt(accounts.length);
		                amount = 50 + rand.nextInt(51); // Generate amount of $30 to $60.
		                transaction = new Transaction(accounts[select], // Account.
